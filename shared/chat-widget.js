(function () {
  const STARTER_QUESTIONS = [
    "What is FEIE and who qualifies?",
    "Do I still need to file US taxes abroad?",
  ...
  panel.innerHTML = `
    <div id="cml-chat-head"><span>Ask AI Tax Advisors</span><button id="cml-chat-reset" type="button">Reset</button></div>
    <div id="cml-chat-log"></div>
    <div id="cml-chat-chips"></div>
    <form id="cml-chat-form">
      <input id="cml-chat-input" type="text" placeholder="Ask about US expat tax..." autocomplete="off" />
  ...
  function resetConversation() {
    history = [];
    log.innerHTML = "";
    addMessage("Hi! Ask me anything about US expat tax topics like FEIE, FBAR, FATCA, and tax treaties.", "bot");
    renderChips();
  }
